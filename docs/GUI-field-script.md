...
| # | Step | Pass |
|---|---|---|
| 0.1 | Run a launch command above → the portal boots (`Uvicorn running on https://0.0.0.0:8760`) and Chrome opens to the card UI. |  |
...
| 0.3 | Open `https://localhost:8760/`, log in → you land on **`/portal/console?mode=setup`** (card-first, not the classic home). The top **readiness bar** paints. |  |
